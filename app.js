...
var incompleteTaskHolder=document.getElementById("todo__list-block");//ul of #todo__list-block
var completedTasksHolder=document.getElementById("todo_done-block");//todo_done-block
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="task-name__input";
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector(".task-name__input");
...
var taskCompleted=function(){
    ...
    //Append the task list item to the #todo_done-block
    var listItem=this.parentNode;
...
//Mark task as incomplete.
    ...
    //Append the task list item to the #todo__list-block.
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
